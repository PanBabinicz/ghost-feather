...
/// \brief
///
union tim_ctrl_gpx_timx_ccmr1_alt
{
    uint32_t r;
    struct bit_field
    {
...
/// \brief
///
union tim_ctrl_gpx_timx_ccmr2_alt
{
    uint32_t r;
    struct bit_field
    {
