...
#define BMI270_INST_MSG_NOT_INIT    (0x00 << 0x00)  /*!< The internal status message ASIC is not init.      */
#define BMI270_INST_MSG_INIT_OK     (0x01 << 0x00)  /*!< The internal status message ASIC initialized.      */
#define BMI270_INST_MSG_INIT_ERR    (0x02 << 0x00)  /*!< The internal status message initialization error.  */
#define BMI270_INST_MSG_DRV_ERR     (0x03 << 0x00)  /*!< The internal status message invalid driver.        */
#define BMI270_INST_MSG_SNS_STOP    (0x04 << 0x00)  /*!< The internal status message sensor stop.           */
#define BMI270_INST_MSG_NVM_ERR     (0x05 << 0x00)  /*!< The internal status message NVM error.             */
#define BMI270_INST_MSG_START_ERR   (0x06 << 0x00)  /*!< The internal status message NVM and init error.    */
...
#define BMI270_ACC_BWP_MSK          (0x07 << 0x04)  /*!< The accelerometer bandwidth mask.                  */
...
#define BMI270_ACC_FILT_PERF_MSK    (0x01 << 0x07)  /*!< The accelerometer filter perfromance mask.         */
...
#define BMI270_GYR_BWP_MSK          (0x03 << 0x04)  /*!< The gyroscope bandwidth mask.                      */
...
#define BMI270_GYR_NOISE_PERF_MSK   (0x01 << 0x06)  /*!< The gyroscope noise performance mask.              */
...
#define BMI270_GYR_FILT_PERF_MSK    (0x01 << 0x07)  /*!< The gyroscope filter performance mask.             */
...
#define BMI270_PWR_CONF_FSW_MSK     (0x01 << 0x01)  /*!< The power conf FIFO read disable in lp mode mask.  */
...
#define BMI270_PWR_CONF_FUP_MSK     (0x01 << 0x02)  /*!< The fast power up enabled mask.                    */
...
#define BMI270_PWR_CTRL_GYR_MSK     (0x01 << 0x01)  /*!< The bmi270 power control gyroscope mask.           */
#define BMI270_PWR_CTRL_GYR_OFF     (0x00 << 0x01)  /*!< The gyroscope off.                                 */
#define BMI270_PWR_CTRL_GYR_ON      (0x01 << 0x01)  /*!< The gyroscope on.                                  */
#define BMI270_PWR_CTRL_ACC_MSK     (0x01 << 0x02)  /*!< The bmi270 power control accelerometer mask.       */
