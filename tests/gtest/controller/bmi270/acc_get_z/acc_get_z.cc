...
///
/// \brief The gtest_bmi270_acc_get_z test fixture class.
///
class gtest_bmi270_acc_get_z : public ::testing::Test
{
    protected:
        ...
        void SetUp() override
        {
            ...
            {
                int16_t z = 0xc0de;
                (void)bmi270_acc_set_z(bmi270, z);
            }
        }
...
struct bmi270_dev *gtest_bmi270_acc_get_z::bmi270 = nullptr;
...
TEST_F(gtest_bmi270_acc_get_z, procedure)
{
    ...
    res = bmi270_acc_get_z(gtest_bmi270_acc_get_z::bmi270, &z);
...
TEST_F(gtest_bmi270_acc_get_z, null_pointer_protection)
{
    ...
    res = bmi270_acc_get_z(gtest_bmi270_acc_get_z::bmi270, NULL);
    EXPECT_EQ(res, BMI270_RES_ERR);
}
