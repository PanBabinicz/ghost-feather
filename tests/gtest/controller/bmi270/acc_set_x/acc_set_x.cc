...
///
/// \brief The gtest_bmi270_acc_set_x test fixture class.
///
class gtest_bmi270_acc_set_x : public ::testing::Test
{
    protected:
...
struct bmi270_dev *gtest_bmi270_acc_set_x::bmi270 = nullptr;

///
/// \brief This test performs the bmi270 accelerometer set x axis procedure.
///
TEST_F(gtest_bmi270_acc_set_x, procedure)
{
    bmi270_res_t res;
    int16_t x;

    res = bmi270_acc_set_x(gtest_bmi270_acc_set_x::bmi270, 0xea5e);
    EXPECT_EQ(res, BMI270_RES_OK);

    res = bmi270_acc_get_x(gtest_bmi270_acc_set_x::bmi270, &x);
    EXPECT_EQ(res, BMI270_RES_OK);
...
///        set x function.
///
TEST_F(gtest_bmi270_acc_set_x, null_pointer_protection)
{
    bmi270_res_t res;
