...
struct bmi270_dev *gtest_bmi270_acc_set_x::dev = nullptr;
...
TEST_F(gtest_bmi270_acc_set_x, procedure)
{
    ...
    res = bmi270_acc_set_x(gtest_bmi270_acc_set_x::dev, 0xea5e);
    EXPECT_EQ(res, BMI270_RES_OK);

    res = bmi270_acc_get_x(gtest_bmi270_acc_set_x::dev, &x);
    EXPECT_EQ(res, BMI270_RES_OK);
