...
struct bmi270_dev *gtest_bmi270_acc_get_y::dev = nullptr;
...
TEST_F(gtest_bmi270_acc_get_y, procedure)
{
    ...
    res = bmi270_acc_get_y(gtest_bmi270_acc_get_y::dev, &y);
...
TEST_F(gtest_bmi270_acc_get_y, null_pointer_protection)
{
    ...
    res = bmi270_acc_get_y(gtest_bmi270_acc_get_y::dev, NULL);
    EXPECT_EQ(res, BMI270_RES_ERR);
}
