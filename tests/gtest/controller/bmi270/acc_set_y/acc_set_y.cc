...
struct bmi270_dev *gtest_bmi270_acc_set_y::dev = nullptr;
...
TEST_F(gtest_bmi270_acc_set_y, procedure)
{
    ...
    res = bmi270_acc_set_y(gtest_bmi270_acc_set_y::dev, 0xdabb);
    EXPECT_EQ(res, BMI270_RES_OK);

    res = bmi270_acc_get_y(gtest_bmi270_acc_set_y::dev, &y);
    EXPECT_EQ(res, BMI270_RES_OK);
