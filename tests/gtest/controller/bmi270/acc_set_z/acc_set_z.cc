...
struct bmi270_dev *gtest_bmi270_acc_set_z::dev = nullptr;
...
TEST_F(gtest_bmi270_acc_set_z, procedure)
{
    ...
    res = bmi270_acc_set_z(gtest_bmi270_acc_set_z::dev, 0xea5e);
    EXPECT_EQ(res, BMI270_RES_OK);

    res = bmi270_acc_get_z(gtest_bmi270_acc_set_z::dev, &z);
    EXPECT_EQ(res, BMI270_RES_OK);
